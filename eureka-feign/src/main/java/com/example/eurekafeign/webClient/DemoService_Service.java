 ...
 * 
 */
@WebServiceClient(name = "DemoService", targetNamespace = "http://interfaces.eurekafeign.example.com", wsdlLocation = "http://localhost:8765/soap/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEMOSERVICE_QNAME = new QName("http://interfaces.eurekafeign.example.com", "DemoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8765/soap/user?wsdl");
    ...
    public DemoService getDemoServiceImplPort() {
        return super.getPort(new QName("http://interfaces.eurekafeign.example.com", "DemoServiceImplPort"), DemoService.class);
    }
    ...
    public DemoService getDemoServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://interfaces.eurekafeign.example.com", "DemoServiceImplPort"), DemoService.class, features);
    }
